...
func TestUserIDPacketNotFollowedBySelfSigKey(t *testing.T) {
	keys, err := ReadArmoredKeyRing(bytes.NewBufferString(userIDPacketNotFollowedBySelfSigKey))
	if err != nil {
		t.Fatal(err)
	}
	if len(keys) != 1 {
		t.Error("Failed to read key with user id packet not followed by a self-sig")
	}
	if numIdentities, numExpected := len(keys[0].Identities), 8; numIdentities != numExpected {
		t.Errorf("accepted %d identities, expected %d", numIdentities, numExpected)
	}
}
...
const userIDPacketNotFollowedBySelfSigKey = `-----BEGIN PGP PUBLIC KEY BLOCK-----


=+1Rr
-----END PGP PUBLIC KEY BLOCK-----
`
