...
func (kr emptyKR) KeysById(id uint64) []Key {
	return nil
}

func (kr emptyKR) DecryptionKeys() []Key {
	return nil
}

func (kr emptyKR) KeysByIdUsage(uint64, byte) []Key {
	return nil
}
...
func TestIssue11503(t *testing.T) {
	...
	_, err = ReadMessage(bytes.NewBuffer(buf), emptyKR{},
