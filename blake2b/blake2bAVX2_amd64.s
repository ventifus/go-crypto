...
#define LOAD_MSG_AVX(m0, m1, m2, m3, src, i0, i1, i2, i3, i4, i5, i6, i7) \
	MOVQ   i0*8(src), m0;     \
...
noinc:
	...
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 0, 2, 4, 6, 1, 3, 5, 7)
	VMOVDQA X8, 16(SP)
	VMOVDQA X9, 32(SP)
	VMOVDQA X10, 48(SP)
	VMOVDQA X11, 64(SP)
	...
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 8, 10, 12, 14, 9, 11, 13, 15)
	VMOVDQA X8, 80(SP)
	VMOVDQA X9, 96(SP)
	VMOVDQA X10, 112(SP)
	VMOVDQA X11, 128(SP)
	...
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 14, 4, 9, 13, 10, 8, 15, 6)
	VMOVDQA X8, 144(SP)
	VMOVDQA X9, 160(SP)
	VMOVDQA X10, 176(SP)
	VMOVDQA X11, 192(SP)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 1, 0, 11, 5, 12, 2, 7, 3)
	VMOVDQA X8, 208(SP)
	VMOVDQA X9, 224(SP)
	VMOVDQA X10, 240(SP)
	VMOVDQA X11, 256(SP)
	...
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 11, 12, 5, 15, 8, 0, 2, 13)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 10, 3, 7, 9, 14, 6, 1, 4)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX_INV()

	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 7, 3, 13, 11, 9, 1, 12, 14)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 2, 5, 4, 15, 6, 10, 0, 8)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX_INV()

	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 9, 5, 2, 10, 0, 7, 4, 15)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 14, 11, 6, 3, 1, 12, 8, 13)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX_INV()

	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 2, 6, 0, 8, 12, 10, 11, 3)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 4, 7, 15, 1, 13, 5, 14, 9)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX_INV()

	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 12, 1, 14, 4, 5, 15, 13, 10)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 0, 6, 9, 8, 7, 3, 2, 11)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX_INV()

	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 13, 7, 12, 3, 11, 14, 1, 9)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 5, 15, 8, 2, 0, 4, 6, 10)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX_INV()

	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 6, 14, 11, 0, 15, 9, 3, 8)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 12, 13, 1, 10, 2, 7, 4, 5)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX_INV()

	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 10, 8, 7, 1, 2, 4, 6, 5)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX()
	LOAD_MSG_AVX(X8, X9, X10, X11, SI, 15, 9, 3, 13, 11, 14, 12, 0)
	HALF_ROUND_AVX(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X11, X13, X14)
	SHUFFLE_AVX_INV()
...
TEXT ·supportAVX(SB), 4, $0-1
	...
	MOVL CX, R9
	MOVL CX, R10
	ANDL $(1<<26), R8  // Bit 26: XGETBV
	ANDL $(1<<27), R9  // Bit 27: OXSAVE
	ANDL $(1<<28), R10 // Bit 28: AVX
	...
	XGETBV
	ANDL $6, AX
	CMPL AX, $6 // AVX not supported by OS
	JNE  NO_AVX
