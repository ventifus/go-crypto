@ Note that this file has been adapted from the original source available under the creative commons 
@ located here : 
@ https://github.com/gvanas/KeccakCodePackage/blob/master/lib/low/KeccakP-1600/OptimizedAsmARM/KeccakP-1600-armv7a-le-neon-gcc.s
@ changes include removal of all functions except for KeccakP1600_Permute_24rounds
@ which has been renamed to KeccakF1600 and now accepts the state array and rc as a parameter on the stack
@ additionally the keccak round loop was unrolled
