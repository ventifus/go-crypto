...
type Response struct {
	...
	// If not set crypto.SHA1 will be used by default. Valid values are crypto.SHA1,
	// crypto.SHA256, crypto.SHA384, and crypto.SHA512.
...
func ParseResponseForCert(bytes []byte, cert, issuer *x509.Certificate) (*Response, error) {
	...
	if ret.IssuerHash == crypto.Hash(0) {
...
// RevocationReason, ThisUpdate, and NextUpdate fields. If template.IssuerHash is
// not set SHA1 will be used by default.
//
