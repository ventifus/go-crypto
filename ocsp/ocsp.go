...
type singleResponse struct {
	...
	NextUpdate asn1.GeneralizedTime `asn1:"explicit,tag:0,optional"`
}

type revokedInfo struct {
	RevocationTime asn1.GeneralizedTime
...
func CreateResponse(issuer, responderCert *x509.Certificate, template Response, priv crypto.Signer) ([]byte, error) {
	...
	innerResponse := singleResponse{
		...
		ThisUpdate: asn1.GeneralizedTime(template.ThisUpdate.UTC()),
		NextUpdate: asn1.GeneralizedTime(template.NextUpdate.UTC()),
	}
	...
	case Revoked:
		innerResponse.Revoked = revokedInfo{
			RevocationTime: asn1.GeneralizedTime(template.RevokedAt.UTC()),
	...
	tbsResponseData := responseDataForMarshal{
		...
		ProducedAt:       asn1.GeneralizedTime(time.Now().Truncate(time.Minute).UTC()),
