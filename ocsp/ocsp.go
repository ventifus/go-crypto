...
func (c *certID) unmarshal(b *cryptobyte.String) bool {
	...
	if !b.ReadASN1(&cert, asn1.TagSequence) ||
...
func (c *certID) Marshal(b *cryptobyte.Builder) error {
	...
	b.AddASN1(asn1.TagSequence, func(cert *cryptobyte.Builder) {
...
func (r *ocspRequest) unmarshal(b *cryptobyte.String) bool {
	...
	if !b.ReadASN1(&ocsp, asn1.TagSequence) ||
...
func (r *ocspRequest) Marshal(b *cryptobyte.Builder) error {
	b.AddASN1(asn1.TagSequence, func(ocsp *cryptobyte.Builder) {
...
func (r *tbsRequest) unmarshal(b *cryptobyte.String) bool {
	...
	if !b.ReadASN1(&tbs, asn1.TagSequence) ||
		...
		!tbs.ReadASN1(&requestList, asn1.TagSequence) ||
...
func (r *tbsRequest) unmarshalRequestList(s *cryptobyte.String) bool {
	...
	if !s.ReadASN1(&reqList, asn1.TagSequence) ||
...
func (r *tbsRequest) Marshal(b *cryptobyte.Builder) error {
	b.AddASN1(asn1.TagSequence, func(tbs *cryptobyte.Builder) {
		if r.Version != 0 {
		...
		tbs.AddASN1(asn1.TagSequence, func(requestList *cryptobyte.Builder) {
			requestList.AddASN1(asn1.TagSequence, func(req *cryptobyte.Builder) {
				req.AddValue(&r.Cert)
			})
		})
	})
...
func (r *responseBytes) unmarshal(b *cryptobyte.String) bool {
	...
	if !b.ReadASN1(&resp, asn1.TagSequence) ||
...
func (r *responseBytes) Marshal(b *cryptobyte.Builder) error {
	b.AddASN1(asn1.TagSequence, func(resp *cryptobyte.Builder) {
...
func (r *responseData) unmarshal(b *cryptobyte.String) bool {
	...
	if !b.ReadASN1Element(&raw, asn1.TagSequence) {
		return false
	}
	r.Raw = raw
	if !raw.ReadASN1(&resp, asn1.TagSequence) || !raw.Empty() ||
		...
		!resp.ReadASN1(&responses, asn1.TagSequence) ||
...
func (r *responseData) unmarshalResponderID(s *cryptobyte.String) bool {
	...
	case asn1.Tag(2).ContextSpecific().Constructed(): // KeyHash
		if !content.ReadASN1Bytes(&r.ResponderKeyHash, asn1.TagOctetString) ||
			!content.Empty() {
			return false
		}
	default:
...
func (r *responseData) Marshal(b *cryptobyte.Builder) error {
	...
	b.AddASN1(asn1.TagSequence, func(resp *cryptobyte.Builder) {
		...
		resp.AddASN1(asn1.TagSequence, func(responses *cryptobyte.Builder) {
...
func (r *singleResponse) unmarshal(b *cryptobyte.String) bool {
	...
	if !b.ReadASN1(&resp, asn1.TagSequence) ||
		!resp.ReadASN1Element(&certID, asn1.TagSequence) ||
...
func (s *subjectPublicKeyInfo) unmarshal(b *cryptobyte.String) bool {
	...
	if !b.ReadASN1(&spki, asn1.TagSequence) ||
...
func CreateResponse(issuer, responderCert *x509.Certificate, template Response, priv crypto.Signer) ([]byte, error) {
	...
	if template.Certificate != nil {
		response.Certificates = []encoding_asn1.RawValue{
			encoding_asn1.RawValue{FullBytes: template.Certificate.Raw},
		}
	}
...
func readAlgorithmIdentifier(b *cryptobyte.String, out *pkix.AlgorithmIdentifier) bool {
	...
	if !b.ReadASN1Element(&alg, asn1.TagSequence) {
		return false
	}
	// TODO(martinkr): Make pkix use cryptobyte.
