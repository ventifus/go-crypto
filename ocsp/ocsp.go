...
func ParseResponseForCert(bytes []byte, cert, issuer *x509.Certificate) (*Response, error) {
	...
	if len(basicResp.TBSResponseData.ResponderName) > 0 {
		...
		// This is really an unmarshaling error but this is hidden by asn1's missing support for UNION.
		return nil, ParseError("none of ResponseID Name or KeyHash present")
	}
