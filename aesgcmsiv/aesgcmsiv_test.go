...
func (h *hexStr) UnmarshalText(text []byte) error {
	ret, out := sliceForAppend(*h, hex.DecodedLen(len(text)))
...
// TestInvalidKey size tests that New rejects invalid key
// lengths.
