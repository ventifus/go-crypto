...
// Package aesgcmsiv implements AES-GCM-SIV per RFC 8452.
//
// AES-GCM-SIV is a nonce misuse-resistant AEAD construction.
// Unlike AES-GCM and other AEAD schemes, AES-GCM-SIV does not
// fail catastrophically if a nonce is repeated.
package aesgcmsiv
...
import (
	...
	"golang.org/x/crypto/internal/polyval"
	"golang.org/x/crypto/internal/subtle"
	"golang.org/x/sys/cpu"
)

var errOpen = errors.New("aesgcmsiv: message authentication failure")
