...
// supportSSSE3 returns true if the runtime (the executing machine) supports SSE3 and SSSE3.
//go:noescape
func supportSSSE3() bool

// supportAVX2 returns true if the runtime (the executing machine) supports AVX2.
//go:noescape
