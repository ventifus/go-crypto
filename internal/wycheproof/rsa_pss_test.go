...
type RsassaPssRoot struct {
	...
	TestGroups    []*RsassaPssTestGroup `json:"testGroups,omitempty"`
}
...
type RsassaPssTestGroup struct {
	...
	// The hash function for hasing the message.
	Sha   string                 `json:"sha,omitempty"`
	Tests []*RsassaPssTestVector `json:"tests,omitempty"`
