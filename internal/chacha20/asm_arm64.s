...
// func xorKeyStream64(dst, src []byte, c *Cipher, counter *uint32, buf *[256]byte, tail bool)
TEXT ·xorKeyStream64(SB), NOSPLIT, $0
	MOVD	dst+0(FP), R1
	MOVD	src+24(FP), R2
	MOVD	src_len+32(FP), R6
	MOVD	cipher+48(FP), R4
...
loop:
	...
	VLD1	(R10), [V0.S4]
	VMOV	V0.B16, V8.B16
	VLD1	(R4), [V1.S4, V2.S4, V3.S4]

	VLD1	(R4), [V9.S4, V10.S4, V11.S4]
...
// func xorKeyStream256(dst, src []byte, c *Cipher, counter *uint32, buf *[256]byte, tail bool)
TEXT ·xorKeyStream256(SB), NOSPLIT, $0
	MOVD	dst+0(FP), R1
	MOVD	src+24(FP), R2
	MOVD	src_len+32(FP), R6
