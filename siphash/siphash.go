...
// Security
//
// SipHash cannot be used as a general purpose cryptographic
// hash function. Neither SipHash-64 nor SipHash-128 provide
// sufficient collision resistants.
package siphash // import "golang.org/x/crypto/siphash"
