...
// and of BLAKE2Xs see https://blake2.net/blake2x.pdf
//
//
// Guidance
//
// If you aren't sure what function you need, use BLAKE2s (Sum256 or New256).
// If you need a secret-key MAC (message authentication code), use the New256
// function with a non-nil key.
//
// BLAKE2X is a construction to compute hash values larger than 32 bytes.
// It can produce hash values between 0 and 65535 bytes.
package blake2s
