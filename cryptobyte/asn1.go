...
// TODO(martinkr): Remove this hack. This will be difficult to use on
// individual fields because we lose struct tags.
...
// ReadGeneralizedTime decodes an ASN.1 GENERALIZEDTIME into out and advances
...
// ReadOptionalASN1Int64 attempts to read an optional ASN.1 INTEGER explicitly
// tagged with tag into out and advances. If no element with a matching tag is
// present, it writes defaultValue into out instead. It returns true on success
// and false on error.
func (s *String) ReadOptionalASN1Int64(out *int64, tag uint8, defaultValue int64) bool {
	var present bool
	var i String
	...
	if !i.ReadASN1Int64(out) || !i.Empty() {
		return false
	}
	return true
}
