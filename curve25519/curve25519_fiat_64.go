...
func fiat_25519_subborrowx_u51(out1 *uint64, out2 *uint8, arg1 uint8, arg2 uint64, arg3 uint64) {
	...
	var x2 = int8((x1 >> 51))
	var x3 = (uint64(x1) & 0x7ffffffffffff)
	*out1 = x3
...
func fiat_25519_carry_mul(out1 *[5]uint64, arg1 *[5]uint64, arg2 *[5]uint64) {
	...
	var x67 = ((x63 >> 51) | ((x65 << 13) & 0xffffffffffffffff))
	var x68 = (x63 & 0x7ffffffffffff)
	var x69 uint64
	var x70 uint64
	...
	var x135 = (x134 + x131)
	var x136 = ((x133 >> 51) | ((x135 << 13) & 0xffffffffffffffff))
	var x137 = (x133 & 0x7ffffffffffff)
	var x138 uint64
	var x139 uint64
	x138, x139 = bits.Add64(x136, x113, 0x0)
	var x140 = (x139 + x115)
	var x141 = ((x138 >> 51) | ((x140 << 13) & 0xffffffffffffffff))
	var x142 = (x138 & 0x7ffffffffffff)
	var x143 uint64
	var x144 uint64
	x143, x144 = bits.Add64(x141, x97, 0x0)
	var x145 = (x144 + x99)
	var x146 = ((x143 >> 51) | ((x145 << 13) & 0xffffffffffffffff))
	var x147 = (x143 & 0x7ffffffffffff)
	var x148 uint64
	var x149 uint64
	x148, x149 = bits.Add64(x146, x81, 0x0)
	var x150 = (x149 + x83)
	var x151 = ((x148 >> 51) | ((x150 << 13) & 0xffffffffffffffff))
	var x152 = (x148 & 0x7ffffffffffff)
	var x153 = (x151 * 0x13)
	var x154 = (x68 + x153)
	var x155 = (x154 >> 51)
	var x156 = (x154 & 0x7ffffffffffff)
	var x157 = (x155 + x137)
	var x158 = (x157 >> 51)
	var x159 = (x157 & 0x7ffffffffffff)
	var x160 = (x158 + x142)
	out1[0] = x156
	out1[1] = x159
	out1[2] = x160
...
func fiat_25519_carry_square(out1 *[5]uint64, arg1 *[5]uint64) {
	...
	var x47 = ((x43 >> 51) | ((x45 << 13) & 0xffffffffffffffff))
	var x48 = (x43 & 0x7ffffffffffff)
	var x49 uint64
	var x50 uint64
	...
	var x83 = (x82 + x79)
	var x84 = ((x81 >> 51) | ((x83 << 13) & 0xffffffffffffffff))
	var x85 = (x81 & 0x7ffffffffffff)
	var x86 uint64
	var x87 uint64
	x86, x87 = bits.Add64(x84, x69, 0x0)
	var x88 = (x87 + x71)
	var x89 = ((x86 >> 51) | ((x88 << 13) & 0xffffffffffffffff))
	var x90 = (x86 & 0x7ffffffffffff)
	var x91 uint64
	var x92 uint64
	x91, x92 = bits.Add64(x89, x61, 0x0)
	var x93 = (x92 + x63)
	var x94 = ((x91 >> 51) | ((x93 << 13) & 0xffffffffffffffff))
	var x95 = (x91 & 0x7ffffffffffff)
	var x96 uint64
	var x97 uint64
	x96, x97 = bits.Add64(x94, x53, 0x0)
	var x98 = (x97 + x55)
	var x99 = ((x96 >> 51) | ((x98 << 13) & 0xffffffffffffffff))
	var x100 = (x96 & 0x7ffffffffffff)
	var x101 = (x99 * 0x13)
	var x102 = (x48 + x101)
	var x103 = (x102 >> 51)
	var x104 = (x102 & 0x7ffffffffffff)
	var x105 = (x103 + x85)
	var x106 = (x105 >> 51)
	var x107 = (x105 & 0x7ffffffffffff)
	var x108 = (x106 + x90)
	out1[0] = x104
	out1[1] = x107
	out1[2] = x108
...
func fiat_25519_carry(out1 *[5]uint64, arg1 *[5]uint64) {
	...
	var x4 = ((x3 >> 51) + (arg1[3]))
	var x5 = ((x4 >> 51) + (arg1[4]))
	var x6 = ((x1 & 0x7ffffffffffff) + ((x5 >> 51) * 0x13))
	var x7 = ((x6 >> 51) + (x2 & 0x7ffffffffffff))
	var x8 = (x6 & 0x7ffffffffffff)
	var x9 = (x7 & 0x7ffffffffffff)
	var x10 = ((x7 >> 51) + (x3 & 0x7ffffffffffff))
	var x11 = (x4 & 0x7ffffffffffff)
	var x12 = (x5 & 0x7ffffffffffff)
	out1[0] = x8
	out1[1] = x9
	out1[2] = x10
	out1[3] = x11
...
func fiat_25519_sub(out1 *[5]uint64, arg1 *[5]uint64, arg2 *[5]uint64) {
	var x1 = ((0xfffffffffffda + (arg1[0])) - (arg2[0]))
	var x2 = ((0xffffffffffffe + (arg1[1])) - (arg2[1]))
	var x3 = ((0xffffffffffffe + (arg1[2])) - (arg2[2]))
	var x4 = ((0xffffffffffffe + (arg1[3])) - (arg2[3]))
	var x5 = ((0xffffffffffffe + (arg1[4])) - (arg2[4]))
	out1[0] = x1
	out1[1] = x2
	out1[2] = x3
	out1[3] = x4
...
func fiat_25519_opp(out1 *[5]uint64, arg1 *[5]uint64) {
	var x1 = (0xfffffffffffda - (arg1[0]))
	var x2 = (0xffffffffffffe - (arg1[1]))
	var x3 = (0xffffffffffffe - (arg1[2]))
	var x4 = (0xffffffffffffe - (arg1[3]))
	var x5 = (0xffffffffffffe - (arg1[4]))
	out1[0] = x1
	out1[1] = x2
	out1[2] = x3
	out1[3] = x4
...
func fiat_25519_to_bytes(out1 *[32]uint8, arg1 *[5]uint64) {
	...
	var x22 = (x20 << 4)
	var x23 = (x18 * uint64(0x2))
	var x24 = (x16 << 6)
	var x25 = (x14 << 3)
	var x26 = (x12 >> 8)
	var x27 = (uint8(x12) & 0xff)
	var x28 = (x26 >> 8)
	var x29 = (uint8(x26) & 0xff)
	var x30 = (x28 >> 8)
	var x31 = (uint8(x28) & 0xff)
	var x32 = (x30 >> 8)
	var x33 = (uint8(x30) & 0xff)
	var x34 = (x32 >> 8)
	var x35 = (uint8(x32) & 0xff)
	var x36 = uint8((x34 >> 8))
	var x37 = (uint8(x34) & 0xff)
	var x38 = (uint64(x36) + x25)
	var x39 = (x38 >> 8)
	var x40 = (uint8(x38) & 0xff)
	var x41 = (x39 >> 8)
	var x42 = (uint8(x39) & 0xff)
	var x43 = (x41 >> 8)
	var x44 = (uint8(x41) & 0xff)
	var x45 = (x43 >> 8)
	var x46 = (uint8(x43) & 0xff)
	var x47 = (x45 >> 8)
	var x48 = (uint8(x45) & 0xff)
	var x49 = uint8((x47 >> 8))
	var x50 = (uint8(x47) & 0xff)
	var x51 = (uint64(x49) + x24)
	var x52 = (x51 >> 8)
	var x53 = (uint8(x51) & 0xff)
	var x54 = (x52 >> 8)
	var x55 = (uint8(x52) & 0xff)
	var x56 = (x54 >> 8)
	var x57 = (uint8(x54) & 0xff)
	var x58 = (x56 >> 8)
	var x59 = (uint8(x56) & 0xff)
	var x60 = (x58 >> 8)
	var x61 = (uint8(x58) & 0xff)
	var x62 = (x60 >> 8)
	var x63 = (uint8(x60) & 0xff)
	var x64 = uint8((x62 >> 8))
	var x65 = (uint8(x62) & 0xff)
	var x66 = (uint64(x64) + x23)
	var x67 = (x66 >> 8)
	var x68 = (uint8(x66) & 0xff)
	var x69 = (x67 >> 8)
	var x70 = (uint8(x67) & 0xff)
	var x71 = (x69 >> 8)
	var x72 = (uint8(x69) & 0xff)
	var x73 = (x71 >> 8)
	var x74 = (uint8(x71) & 0xff)
	var x75 = (x73 >> 8)
	var x76 = (uint8(x73) & 0xff)
	var x77 = uint8((x75 >> 8))
	var x78 = (uint8(x75) & 0xff)
	...
	var x84 = (x82 >> 8)
	var x85 = (uint8(x82) & 0xff)
	var x86 = (x84 >> 8)
	var x87 = (uint8(x84) & 0xff)
	var x88 = (x86 >> 8)
	var x89 = (uint8(x86) & 0xff)
	var x90 = uint8((x88 >> 8))
	var x91 = (uint8(x88) & 0xff)
	out1[0] = x27
	out1[1] = x29
	out1[2] = x31
	out1[3] = x33
...
func fiat_25519_from_bytes(out1 *[5]uint64, arg1 *[32]uint8) {
	...
	var x34 = uint8((x33 >> 51))
	var x35 = (x33 & 0x7ffffffffffff)
	var x36 = (x6 + (x5 + (x4 + (x3 + (x2 + x1)))))
	var x37 = (x12 + (x11 + (x10 + (x9 + (x8 + x7)))))
	var x38 = (x19 + (x18 + (x17 + (x16 + (x15 + (x14 + x13))))))
	var x39 = (x25 + (x24 + (x23 + (x22 + (x21 + x20)))))
	var x40 = (uint64(x34) + x39)
	var x41 = uint8((x40 >> 51))
	var x42 = (x40 & 0x7ffffffffffff)
	var x43 = (uint64(x41) + x38)
	var x44 = uint8((x43 >> 51))
	var x45 = (x43 & 0x7ffffffffffff)
	var x46 = (uint64(x44) + x37)
	var x47 = uint8((x46 >> 51))
	var x48 = (x46 & 0x7ffffffffffff)
...
func fiat_25519_carry_scmul_121666(out1 *[5]uint64, arg1 *[5]uint64) {
	...
	var x11 = ((x9 >> 51) | ((x10 << 13) & 0xffffffffffffffff))
	var x12 = (x9 & 0x7ffffffffffff)
	var x13 uint64
	var x14 uint64
	x13, x14 = bits.Add64(x11, x7, 0x0)
	var x15 = (x14 + x8)
	var x16 = ((x13 >> 51) | ((x15 << 13) & 0xffffffffffffffff))
	var x17 = (x13 & 0x7ffffffffffff)
	var x18 uint64
	var x19 uint64
	x18, x19 = bits.Add64(x16, x5, 0x0)
	var x20 = (x19 + x6)
	var x21 = ((x18 >> 51) | ((x20 << 13) & 0xffffffffffffffff))
	var x22 = (x18 & 0x7ffffffffffff)
	var x23 uint64
	var x24 uint64
	x23, x24 = bits.Add64(x21, x3, 0x0)
	var x25 = (x24 + x4)
	var x26 = ((x23 >> 51) | ((x25 << 13) & 0xffffffffffffffff))
	var x27 = (x23 & 0x7ffffffffffff)
	var x28 uint64
	var x29 uint64
	x28, x29 = bits.Add64(x26, x1, 0x0)
	var x30 = (x29 + x2)
	var x31 = ((x28 >> 51) | ((x30 << 13) & 0xffffffffffffffff))
	var x32 = (x28 & 0x7ffffffffffff)
	var x33 = (x31 * 0x13)
	var x34 = (x12 + x33)
	var x35 = (x34 >> 51)
	var x36 = (x34 & 0x7ffffffffffff)
	var x37 = (x35 + x17)
	var x38 = (x37 >> 51)
	var x39 = (x37 & 0x7ffffffffffff)
	var x40 = (x38 + x22)
	out1[0] = x36
	out1[1] = x39
	out1[2] = x40
