...
func LOAD_MSG_0(block GPPhysical, off int) {
	Comment("Avo Signature: func LOAD_MSG_0(block GPPhysical, off int) {")
...
func STORE_MSG_0(block GPPhysical, off int) {
	Comment("Avo Signature: func STORE_MSG_0(block GPPhysical, off int) {")
	var registers = []VecPhysical{X0, X1, X2, X3, X4, X5, X6, X7}
	for i, r := range registers {
...
func LOAD_MSG_1(block GPPhysical, off int) {
	Comment("Avo Signature: func LOAD_MSG_1(block GPPhysical, off int) {")
	var registers = []VecPhysical{X0, X1, X2, X3, X4, X5, X6, X7}
	for i, r := range registers {
...
func STORE_MSG_1(block GPPhysical, off int) {
	Comment("Avo Signature: func STORE_MSG_1(block GPPhysical, off int) {")
	var registers = []VecPhysical{X0, X1, X2, X3, X4, X5, X6, X7}
	for i, r := range registers {
