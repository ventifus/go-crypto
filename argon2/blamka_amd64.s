...
TEXT ·blamkaSSE4(SB), NOSPLIT, $0-8
	...
	// Avo Signature: func LOAD_MSG_0(block GPPhysical, off int) {
	MOVOU      (AX), X0
	MOVOU      16(AX), X1
	MOVOU      32(AX), X2
	MOVOU      48(AX), X3
	...
	// Avo Signature: func STORE_MSG_0(block GPPhysical, off int) {
	MOVOU X0, (AX)
	MOVOU X1, 16(AX)
	MOVOU X2, 32(AX)
	MOVOU X3, 48(AX)
	...
	// Avo Signature: func LOAD_MSG_1(block GPPhysical, off int) {
	MOVOU      (AX), X0
	MOVOU      128(AX), X1
	MOVOU      256(AX), X2
	MOVOU      384(AX), X3
	...
	// Avo Signature: func STORE_MSG_1(block GPPhysical, off int) {
	MOVOU X0, (AX)
	MOVOU X1, 128(AX)
	MOVOU X2, 256(AX)
	MOVOU X3, 384(AX)
