...
// Register and stack allocation for the AVX2 code
#define rsStoreAVX512 (0*64)(BP)
#define state1StoreAVX512 (1*64)(BP)
#define state2StoreAVX512 (2*64)(BP)
#define ctr0StoreAVX512 (3*64)(BP)
#define ctr1StoreAVX512 (4*64)(BP)
#define ctr2StoreAVX512 (5*64)(BP)
#define ctr3StoreAVX512 (6*64)(BP)
#define tmpStoreAVX512 (7*64)(BP) // 256 bytes on stack
...
GLOBL ·avx512IncMask<>(SB), (NOPTR+RODATA), $64
GLOBL ·avx512InitMask<>(SB), (NOPTR+RODATA), $64
...
#define chachaQR_AVX512(A, B, C, D, T) \
	VPADDD B, A, A; VPXOR A, D, D; VPROLD $16, D, D \
	VPADDD D, C, C; VPXOR C, B, B; VPROLD $12, B, B \
	VPADDD B, A, A; VPXOR A, D, D; VPROLD $8, D, D \
	VPADDD D, C, C; VPXOR C, B, B; VPROLD $7, B, B
...
openAVX2PreparePolyKey:
	...
	JMP continueOpenAVX512Loop
openAVX512Loop:
	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0)
	VPSHUFD  $0x39, BB0, BB0; VPSHUFD $0x4E, CC0, CC0; VPSHUFD $0x93, DD0, DD0
        chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0)
	VPSHUFD  $0x93, BB0, BB0; VPSHUFD $0x4E, CC0, CC0; VPSHUFD $0x39, DD0, DD0
continueOpenAVX512Loop:
	DECQ     itr2
...
openAVX512InternalLoop:
	...
	polyMulStage1_AVX2
	VPXOR    AA0, DD0, DD0; VPXOR AA1, DD1, DD1; VPXOR AA2, DD2, DD2; VPXOR AA3, DD3, DD3
	VPROLD $16, DD0, DD0; VPROLD $16, DD1, DD1; VPROLD $16, DD2, DD2; VPROLD $16, DD3, DD3
	polyMulStage2_AVX2
	VPADDD   DD0, CC0, CC0; VPADDD DD1, CC1, CC1; VPADDD DD2, CC2, CC2; VPADDD DD3, CC3, CC3
	VPXOR    CC0, BB0, BB0; VPXOR CC1, BB1, BB1; VPXOR CC2, BB2, BB2; VPXOR CC3, BB3, BB3
	polyMulStage3_AVX2
	VPROLD   $12, BB0, BB0; VPROLD   $12, BB1, BB1; VPROLD   $12, BB2, BB2; VPROLD   $12, BB3, BB3
	polyMulReduceStage
	VPADDD   BB0, AA0, AA0; VPADDD BB1, AA1, AA1; VPADDD BB2, AA2, AA2; VPADDD BB3, AA3, AA3
	VPXOR    AA0, DD0, DD0; VPXOR AA1, DD1, DD1; VPXOR AA2, DD2, DD2; VPXOR AA3, DD3, DD3
	VPROLD   $8, DD0, DD0; VPROLD $8, DD1, DD1; VPROLD $8, DD2, DD2; VPROLD $8, DD3, DD3
	polyAdd(2*8(inp)(itr1*1))
	VPADDD   DD0, CC0, CC0; VPADDD DD1, CC1, CC1; VPADDD DD2, CC2, CC2; VPADDD DD3, CC3, CC3
	polyMulStage1_AVX2
	VPXOR    CC0, BB0, BB0; VPXOR CC1, BB1, BB1; VPXOR CC2, BB2, BB2; VPXOR CC3, BB3, BB3
	VPROLD   $7, BB0, BB0; VPROLD   $7, BB1, BB1; VPROLD   $7, BB2, BB2; VPROLD   $7, BB3, BB3
	polyMulStage2_AVX2
	VPSHUFD  $0x39, BB0, BB0; VPSHUFD $0x39, BB1, BB1; VPSHUFD $0x39, BB2, BB2; VPSHUFD $0x39, BB3, BB3
	VPSHUFD  $0x4E, CC0, CC0; VPSHUFD $0x4E, CC1, CC1; VPSHUFD $0x4E, CC2, CC2; VPSHUFD $0x4E, CC3, CC3
	VPSHUFD  $0x93, DD0, DD0; VPSHUFD $0x93, DD1, DD1; VPSHUFD $0x93, DD2, DD2; VPSHUFD $0x93, DD3, DD3
	VPADDD   BB0, AA0, AA0; VPADDD BB1, AA1, AA1; VPADDD BB2, AA2, AA2; VPADDD BB3, AA3, AA3
	polyMulStage3_AVX2
	VPXOR    AA0, DD0, DD0; VPXOR AA1, DD1, DD1; VPXOR AA2, DD2, DD2; VPXOR AA3, DD3, DD3
	VPROLD   $16, DD0, DD0; VPROLD $16, DD1, DD1; VPROLD $16, DD2, DD2; VPROLD $16, DD3, DD3
	...
	VPROLD   $7, BB0, BB0; VPROLD   $7, BB1, BB1; VPROLD   $7, BB2, BB2; VPROLD   $7, BB3, BB3
	polyMulReduceStage
	VPSHUFD  $0x93, BB0, BB0; VPSHUFD $0x93, BB1, BB1; VPSHUFD $0x93, BB2, BB2; VPSHUFD $0x93, BB3, BB3
	VPSHUFD  $0x4E, CC0, CC0; VPSHUFD $0x4E, CC1, CC1; VPSHUFD $0x4E, CC2, CC2; VPSHUFD $0x4E, CC3, CC3
	VPSHUFD  $0x39, DD0, DD0; VPSHUFD $0x39, DD1, DD1; VPSHUFD $0x39, DD2, DD2; VPSHUFD $0x39, DD3, DD3	

	CMPQ     itr1, $480
	JNE      openAVX512InternalLoop
	JMP      continueOpenAVX2InternalLoop
...
openAVX2192InnerCipherLoop:
	...
	JMP 	continueOpenAVX512192InternalLoop

openAVX512192InternalLoop:

	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0); chachaQR_AVX512(AA1, BB1, CC1, DD1, TT0)
	VPSHUFD  $0x39, BB0, BB0; VPSHUFD $0x39, BB1, BB1
	VPSHUFD  $0x4E, CC0, CC0; VPSHUFD $0x4E, CC1, CC1
	VPSHUFD  $0x93, DD0, DD0; VPSHUFD $0x93, DD1, DD1
	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0); chachaQR_AVX512(AA1, BB1, CC1, DD1, TT0)
	VPSHUFD  $0x93, BB0, BB0; VPSHUFD $0x93, BB1, BB1
	VPSHUFD  $0x4E, CC0, CC0; VPSHUFD $0x4E, CC1, CC1
	VPSHUFD  $0x39, DD0, DD0; VPSHUFD $0x39, DD1, DD1

continueOpenAVX512192InternalLoop:
	DECQ       itr2
...
openAVX2320InnerCipherLoop:
	...
	JMP continueOpenAVX2320Loop
openAVX512320InternalLoop:

	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0); chachaQR_AVX512(AA1, BB1, CC1, DD1, TT0); chachaQR_AVX512(AA2, BB2, CC2, DD2, TT0)
	VPSHUFD  $0x39, BB0, BB0; VPSHUFD $0x39, BB1, BB1; VPSHUFD $0x39, BB2, BB2
	VPSHUFD  $0x4E, CC0, CC0; VPSHUFD $0x4E, CC1, CC1; VPSHUFD $0x4E, CC2, CC2
	VPSHUFD  $0x93, DD0, DD0; VPSHUFD $0x93, DD1, DD1; VPSHUFD $0x93, DD2, DD2
	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0); chachaQR_AVX512(AA1, BB1, CC1, DD1, TT0); chachaQR_AVX512(AA2, BB2, CC2, DD2, TT0)
	VPSHUFD  $0x93, BB0, BB0; VPSHUFD $0x93, BB1, BB1; VPSHUFD $0x93, BB2, BB2
	VPSHUFD  $0x4E, CC0, CC0; VPSHUFD $0x4E, CC1, CC1; VPSHUFD $0x4E, CC2, CC2
	VPSHUFD  $0x39, DD0, DD0; VPSHUFD $0x39, DD1, DD1; VPSHUFD $0x39, DD2, DD2
continueOpenAVX2320Loop:
	DECQ     itr2
...
openAVX2Tail256LoopB:
	...
	VPALIGNR $8, CC0, CC0, CC0; VPALIGNR $8, CC1, CC1, CC1
	VPALIGNR $4, DD0, DD0, DD0; VPALIGNR $4, DD1, DD1, DD1
	JMP   continueOpenAVX512Tail256LoopB
openAVX512Tail256LoopB:
	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0); chachaQR_AVX512(AA1, BB1, CC1, DD1, TT0)
	VPSHUFD  $0x39, BB0, BB0; VPSHUFD $0x39, BB1, BB1
	VPSHUFD  $0x4E, CC0, CC0; VPSHUFD $0x4E, CC1, CC1
	VPSHUFD  $0x93, DD0, DD0; VPSHUFD $0x93, DD1, DD1
...
continueOpenAVX512Tail256LoopB:
	CMPQ     itr2, itr1
...
openAVX2Tail384LoopA:
	...
	VPALIGNR $8, CC0, CC0, CC0; VPALIGNR $8, CC1, CC1, CC1; VPALIGNR $8, CC2, CC2, CC2
	VPALIGNR $4, DD0, DD0, DD0; VPALIGNR $4, DD1, DD1, DD1; VPALIGNR $4, DD2, DD2, DD2
	JMP continueOpenAVX2Tail384LoopA
openAVX512Tail384LoopB:
	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0); chachaQR_AVX512(AA1, BB1, CC1, DD1, TT0); chachaQR_AVX512(AA2, BB2, CC2, DD2, TT0)
	VPSHUFD  $0x39, BB0, BB0; VPSHUFD $0x39, BB1, BB1; VPSHUFD $0x39, BB2, BB2
	VPSHUFD  $0x4E, CC0, CC0; VPSHUFD $0x4E, CC1, CC1; VPSHUFD $0x4E, CC2, CC2
	VPSHUFD  $0x93, DD0, DD0; VPSHUFD $0x93, DD1, DD1; VPSHUFD $0x93, DD2, DD2
...
openAVX2Tail512LoopA:
	...
	VPALIGNR $8, CC0, CC0, CC0; VPALIGNR $8, CC1, CC1, CC1; VPALIGNR $8, CC2, CC2, CC2; VPALIGNR $8, CC3, CC3, CC3
	VPALIGNR $4, DD0, DD0, DD0; VPALIGNR $4, DD1, DD1, DD1; VPALIGNR $4, DD2, DD2, DD2; VPALIGNR $4, DD3, DD3, DD3
	JMP continue512TailLoop
internalAVX512Tail512LoopA:
	VPROLD   $12, BB0, BB0; VPROLD   $12, BB1, BB1; VPROLD   $12, BB2, BB2; VPROLD   $12, BB3, BB3
	polyAdd(0*8(itr2))
	polyMulAVX2
	VPADDD   BB0, AA0, AA0; VPADDD BB1, AA1, AA1; VPADDD BB2, AA2, AA2; VPADDD BB3, AA3, AA3
...
sealAVX2IntroLoop:
	...
	JMP continueSealIntroLoop

sealAVX512IntroLoop:

	chachaQR_AVX512(AA0, BB0, CC0, DD0, CC3); chachaQR_AVX512(AA1, BB1, CC1, DD1, CC3); chachaQR_AVX512(AA2, BB2, CC2, DD2, CC3)
	chachaQR_AVX512(AA3, BB3, CC3, DD3, CC1)

	VPSHUFD $0x39, BB0, BB0; VPSHUFD $0x4E, CC0, CC0; VPSHUFD $0x93, DD0, DD0
	VPSHUFD $0x39, BB1, BB1; VPSHUFD $0x4E, CC1, CC1; VPSHUFD $0x93, DD1, DD1
	VPSHUFD $0x39, BB2, BB2; VPSHUFD $0x4E, CC2, CC2; VPSHUFD $0x93, DD2, DD2
	VPSHUFD $0x39, BB3, BB3; VPSHUFD $0x4E, CC3, CC3; VPSHUFD $0x93, DD3, DD3
	chachaQR_AVX512(AA0, BB0, CC0, DD0, CC3); chachaQR_AVX512(AA1, BB1, CC1, DD1, CC3); chachaQR_AVX512(AA2, BB2, CC2, DD2, CC3)
	chachaQR_AVX512(AA3, BB3, CC3, DD3, CC1)

	VPSHUFD $0x93, BB0, BB0; VPSHUFD $0x4E, CC0, CC0; VPSHUFD $0x39, DD0, DD0
	VPSHUFD $0x93, BB1, BB1; VPSHUFD $0x4E, CC1, CC1; VPSHUFD $0x39, DD1, DD1
	VPSHUFD $0x93, BB2, BB2; VPSHUFD $0x4E, CC2, CC2; VPSHUFD $0x39, DD2, DD2
	VPSHUFD $0x93, BB3, BB3; VPSHUFD $0x4E, CC3, CC3; VPSHUFD $0x39, DD3, DD3
continueSealIntroLoop:
...
sealAVX2InternalLoop:
	...
	VMOVDQA tmpStoreAVX2, CC3
	polyMulReduceStage
	JMP continueSealAVX2Loop

sealVX512InternalLoop:
	...
	VPROLD   $12, BB0, BB0; VPROLD   $12, BB1, BB1; VPROLD   $12, BB2, BB2; VPROLD   $12, BB3, BB3
	polyMulReduceStage
	JMP sealVX512InternalLoopStart

sealAVX2InternalLoopStart:
	CMPB ·useAVX512(SB), $1
	JE   sealVX512InternalLoopStart

continueSealAVX2Loop:
	VPADDD   BB0, AA0, AA0; VPADDD BB1, AA1, AA1; VPADDD BB2, AA2, AA2; VPADDD BB3, AA3, AA3
	VPXOR    AA0, DD0, DD0; VPXOR AA1, DD1, DD1; VPXOR AA2, DD2, DD2; VPXOR AA3, DD3, DD3
	VPSHUFB  ·rol8<>(SB), DD0, DD0; VPSHUFB ·rol8<>(SB), DD1, DD1; VPSHUFB ·rol8<>(SB), DD2, DD2; VPSHUFB ·rol8<>(SB), DD3, DD3	
	polyAdd(2*8(oup))
	...
	VPALIGNR $8, CC0, CC0, CC0; VPALIGNR $8, CC1, CC1, CC1; VPALIGNR $8, CC2, CC2, CC2; VPALIGNR $8, CC3, CC3, CC3
	VPALIGNR $4, DD0, DD0, DD0; VPALIGNR $4, DD1, DD1, DD1; VPALIGNR $4, DD2, DD2, DD2; VPALIGNR $4, DD3, DD3, DD3
	JMP continueSealAVX512Internal

sealVX512InternalLoopStart:
...
sealAVX2192InnerCipherLoop:
	...
	VPALIGNR   $8, CC0, CC0, CC0; VPALIGNR $8, CC1, CC1, CC1
	VPALIGNR   $4, DD0, DD0, DD0; VPALIGNR $4, DD1, DD1, DD1
	JMP     continueAVX512seal192InternalLoop

sealAVX512192InternalLoop:
	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0); chachaQR_AVX512(AA1, BB1, CC1, DD1, TT0)
	VPSHUFD  $0x39, BB0, BB0; VPSHUFD $0x39, BB1, BB1
	VPSHUFD  $0x4E, CC0, CC0; VPSHUFD $0x4E, CC1, CC1
	VPSHUFD  $0x93, DD0, DD0; VPSHUFD $0x93, DD1, DD1
...
continueAVX512seal192InternalLoop:
...
sealAVX2320InnerCipherLoop:
	...
	VPALIGNR $8, CC0, CC0, CC0; VPALIGNR $8, CC1, CC1, CC1; VPALIGNR $8, CC2, CC2, CC2
	VPALIGNR $4, DD0, DD0, DD0; VPALIGNR $4, DD1, DD1, DD1; VPALIGNR $4, DD2, DD2, DD2
	JMP continueSealAVX2320InnerCipherLoop

sealAVX512Tail320LoopB:
...
continueSealAVX2320InnerCipherLoop:
	DECQ     itr2
...
sealAVX2Tail128LoopB:
	...
	JMP continueSealAVX2Tail128LoopB

sealAVX512Tail128LoopB:

	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0)
	polyAdd(0(oup))
	polyMul
	VPSHUFD  $0x39, BB0, BB0
	VPSHUFD  $0x4E, CC0, CC0
	VPSHUFD  $0x93, DD0, DD0
	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0)
	polyAdd(16(oup))
	polyMul
	LEAQ     32(oup), oup
	VPSHUFD  $0x93, BB0, BB0
	VPSHUFD  $0x4E, CC0, CC0
	VPSHUFD  $0x39, DD0, DD0

continueSealAVX2Tail128LoopB:
...
sealAVX2Tail256LoopB:
	...
	VPALIGNR $8, CC0, CC0, CC0; VPALIGNR $8, CC1, CC1, CC1
	VPALIGNR $4, DD0, DD0, DD0; VPALIGNR $4, DD1, DD1, DD1
	JMP continueSealAVX2Tail256LoopB

sealAVX512Tail256LoopB:
	chachaQR_AVX512(AA0, BB0, CC0, DD0, TT0); chachaQR_AVX512(AA1, BB1, CC1, DD1, TT0)
	polyAdd(0(oup))
	polyMul
	VPSHUFD  $0x39, BB0, BB0; VPSHUFD $0x39, BB1, BB1
...
sealAVX2Tail384LoopB:
	...
	VPALIGNR $8, CC0, CC0, CC0; VPALIGNR $8, CC1, CC1, CC1; VPALIGNR $8, CC2, CC2, CC2
	VPALIGNR $4, DD0, DD0, DD0; VPALIGNR $4, DD1, DD1, DD1; VPALIGNR $4, DD2, DD2, DD2
	JMP continueSealAVX512Tail384

sealAVX512Tail384LoopB:
...
sealAVX2Tail512LoopB:
	...
	VPALIGNR $8, CC0, CC0, CC0; VPALIGNR $8, CC1, CC1, CC1; VPALIGNR $8, CC2, CC2, CC2; VPALIGNR $8, CC3, CC3, CC3
	VPALIGNR $4, DD0, DD0, DD0; VPALIGNR $4, DD1, DD1, DD1; VPALIGNR $4, DD2, DD2, DD2; VPALIGNR $4, DD3, DD3, DD3
	JMP continueSeal512LoopB

sealAVX512Tail512LoopB:
