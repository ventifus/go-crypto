...
func TestFingerprintLegacyMD5(t *testing.T) {
	...
	want := "fb:61:6d:1a:e3:f0:95:45:3c:a0:79:be:4a:93:63:66" // ssh-keygetn -lf -E md5 rsa
	if fingerprint != want {
...
func TestFingerprintSHA256(t *testing.T) {
	...
	want := "SHA256:Anr3LjZK8YVpjrxu79myrW9Hrb/wpcMNpVvTq/RcBm8" // ssh-keygetn -lf rsa
	if fingerprint != want {
		t.Errorf("got fingerprint %q want %q", fingerprint, want)
	}
}
