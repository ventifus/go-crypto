...
write:
	for t.getWriteError() == nil {
		...
		// writers may be driven from our read loop. Drain the
		// requestKex channel. We don't have to drain the startKex,
		// because the remote end has just sent us a kexInitMsg.
		...
		// sendKexInit sets kexInProgress, so t.conn is also
		// free for writing.
...
func (t *handshakeTransport) sendKexInit() error {
	...
	// since t.kexInProgress is set, we are free to write to t.conn from here on.
