...
// verifies that the signature key of the certificate is valid but not that it is
// a valid user or host authority. This method does not actually authenticate
// the certificate at all or enforce a certificate type, see
