...
// GSSAPIWithMICCallback is an AuthMethod with "gssappi-with-mic" authentication.
// See RFC 4462 session 3
type GSSAPIWithMICCallback struct {
	// GSSAPIClient implements the GSSAPIClient interface, see the definition of the interface for details.
