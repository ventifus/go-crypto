...
// use for signing. An AlgorithmSigner can't advertise the algorithms it
// supports, so it should be prepared to be invoked with every algorithm
// supported by the public key format.
