...
func serverForUnsupportedConfigOptions(config *ServerConfig, t *testing.T) {
	reader := rand.Reader
	bitSize := 2048
	...
	go func() {
		clientError <- clientForUnsupportedConfigOptions(listener)
	}()
...
func clientForUnsupportedConfigOptions(listener net.Listener) error {
...
func TestUnsupportedMACError(t *testing.T) {
	...
	serverForUnsupportedConfigOptions(config, t)
}
