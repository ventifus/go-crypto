...
// nettest fail this way:
//
// -- FAIL: TestChannelsNetTest/BasicIO (0.01s)
// conntest.go:87: unexpected c2.Close error: EOF
// FAIL: TestChannelsNetTest/PingPong (0.00s)
// conntest.go:131: unexpected Close error: EOF
//
// Because Write return io.EOF after sending msgChannelClose.
// All other tests in nettest work.
