...
// [ssh.Config.Ciphers]. For a list, see the [ssh.Algorithms.Ciphers] returned by
...
// in [ssh.Config.KeyExchanges]. For a list, see the
// [ssh.Algorithms.KeyExchanges] returned by [SupportedAlgorithms] or
// [InsecureAlgorithms].
const (
...
// this library, to use in [ssh.Config.MACs]. For a list, see the
// [ssh.Algorithms.MACs] returned by [SupportedAlgorithms] or
// [InsecureAlgorithms].
const (
