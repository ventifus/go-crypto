...
var (
	...
	// security issues.
	supportedServerKexAlgos = []string{KexAlgoCurve25519SHA256,
		KexAlgoECDH256, KexAlgoECDH384, KexAlgoECDH521,
		KexAlgoDH14SHA256, KexAlgoDH16SHA512}
	// supportedClientKexAlgos specifies client-side key-exchange algorithms
	// implemented by this package in preference order, excluding those with
	// security issues.
	supportedClientKexAlgos = append(supportedServerKexAlgos, KexAlgoDHGEXSHA256)
	// preferredKexAlgos specifies the default preference for key-exchange
	// algorithms in preference order. The diffie-hellman-group16-sha512
	// algorithm is disabled by default because it is a bit slower than the
	// others.
