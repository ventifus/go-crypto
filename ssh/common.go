...
var (
	...
	supportedKexAlgos = []string{KeyExchangeCurve25519SHA256,
		KeyExchangeECDH256, KeyExchangeECDH384, KeyExchangeECDH521,
	...
	// by this package.
	fipsKexAlgos = []string{KeyExchangeECDH256, KeyExchangeECDH384,
		KeyExchangeDH14SHA256, KeyExchangeDHGEXSHA256, KeyExchangeDH16SHA512}
	...
	// package.
	fipsCiphers = []string{
		CipherAES256GCM, CipherAES256CTR,
		CipherAES128GCM, CipherAES128CTR,
	}
	...
	preferredMACs = []string{HMACSHA256ETM, HMACSHA512ETM,
		HMACSHA256, HMACSHA512, InsecureHMACSHA196, InsecureHMACSHA1,
	}
