...
// localListener is set up by TestMain and used by localServer to create Conn
...
const localFlakes = 0 // change to 1 or 2 to exercise localServer handling of mismatches
