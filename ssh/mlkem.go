...
func init() {
	...
	supportedKexAlgos = slices.Insert(supportedKexAlgos, 0, KeyExchangeMLKEM768X25519SHA256)
	preferredKexAlgos = slices.Insert(preferredKexAlgos, 0, KeyExchangeMLKEM768X25519SHA256)
	kexAlgoMap[KeyExchangeMLKEM768X25519SHA256] = &mlkem768WithCurve25519sha256{}
}
