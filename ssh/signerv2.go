...
// OpenSSH format.
func MarshalPrivateKeyV2(key crypto.Signer, options *MarshalPrivateKeyV2Options) (*pem.Block, error) {
	if options == nil {
...
func ParsePrivateKeyV2(pemBytes []byte, options *ParsePrivateKeyV2Options) (crypto.Signer, error) {
	if options == nil {
