...
func TestBannerCallback(t *testing.T) {
	...
	var receivedBanner, receivedLanguage string
	clientConf := ClientConfig{
		User:            "user",
		HostKeyCallback: InsecureIgnoreHostKey(),
		BannerCallback: func(message, language string) error {
	...
	expected = "en"
	if receivedLanguage != expected {
		t.Fatalf("got %s; want %s", receivedLanguage, expected)
	}
}
