...
// using errors.As and then implementations can compose it with other errors.
...
// error is checked using errors.As and then implementations can compose it with
// other errors.
