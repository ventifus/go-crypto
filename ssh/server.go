...
func NewServerConn(c net.Conn, config *ServerConfig) (*ServerConn, <-chan NewChannel, <-chan *Request, error) {
	...
	// It is not required to check ciphers since SetDefaults removes the ciphers that have no definition
	// Should we not warn about this instead of silently ignoring unsupported ciphers?
