...
type GSSAPIWithMICConfig struct {
	...
	// of the Server interface. See Server interface for details.
	Server GSSAPIServer
}
...
type ServerConfig struct {
	...
	// when gssapi-with-mic authentication is selected(RFC 4462 session 3).
...
userAuthLoop:
	...
	selectMethod:
		...
		case "gssapi-with-mic":
			...
			gssapiServer.DeleteSecContext()
			return gssapiConfig.Callback(s, srcName)
