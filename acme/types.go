...
type Order struct {
	...
	// to obtain a certificate. This is done with Client's CreateCert method.
	// Processing means the certificate is being issued.
	// Valid indicates the CA has issued the certificate. It can be downloaded
	// from the Order's CertURL. This is done with Client's FetchCert method.
	...
	// Required authorizations can be identified by their "pending" status.
	//
	// For orders in the "valid" or "invalid" state these are the authorizations
...
// Users can also use DomainID and IPID helpers.
type AuthzID struct {
	Type  string // The type of identifier, "dns" or "ip".
	Value string // The identifier itself, e.g. "example.org".
}

// DomainID creates a slice of AuthzID with "dns" identifier type.
func DomainID(names ...string) []AuthzID {
...
// IPID creates a slice of AuthzID with "ip" identifier type.
// Each element of addr is textual form of an address as defined
// in RFC1123 Section 2.1 for IPv4 and in RFC5952 Section 4 for IPv6.
func IPID(addr ...string) []AuthzID {
...
//
// JSON tags are added for easier testing when serializing an error
// in a response.
