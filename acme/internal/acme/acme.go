...
// HTTP01ChallengeToken returns the response answer value for an http-01 challenge.
// Servers can respond with the value to HTTP requests at the indicated URL path
