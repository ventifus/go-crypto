...
func (c *Client) Discover() (Directory, error) {
	...
	var dir Directory
	res, err := c.httpClient().Get(c.dirURL())
	if err != nil {
		return dir, err
	}
	defer res.Body.Close()
	if res.StatusCode != http.StatusOK {
		return dir, responseError(res)
	}
	var v struct {
	...
	dir.RegURL = v.Reg
	dir.AuthzURL = v.Authz
	dir.CertURL = v.Cert
	dir.RevokeURL = v.Revoke
	dir.Terms = v.Meta.Terms
	dir.Website = v.Meta.Website
	dir.CAA = v.Meta.CAA
	c.dir = &dir
