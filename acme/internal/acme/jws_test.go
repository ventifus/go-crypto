...
func TestJWKThumbprintEC(t *testing.T) {
	...
	// tr -d '=' | tr '/+' '_-'
	const (
		base64X  = "MKBCTNIcKUSDii11ySs3526iDZ8AiTo7Tu6KPAqv7D4"
		base64Y  = "4Etl6SRW2YiLUrN5vfvVHuhp7x8PxltmWWlbbM4IFyM"
		expected = "cn-I_WNMClehiVp51i_0VpOENW1upEerA8sEam5hn-s"
	)
