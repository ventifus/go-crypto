...
// most famously used by LetsEncrypt.
//
...
// While code using the old API will still compile, it won't actually
// work because LetsEncrypt has removed support for the pre-RFC ACME
// spec. Note the deprecation comments to update your code.
//
