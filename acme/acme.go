...
// Discover performs ACME server discovery using provided discovery endpoint url.
...
// The returned der bytes, however, may be nil even if no error occurred.
...
//
// The url argument is typically an Endpoint.RegURL obtained from c.Discover.
...
// It returns updated account copy. The a argument is not modified.
//
