...
func (c *Client) CreateCert(ctx context.Context, csr []byte, exp time.Duration, bundle bool) (der [][]byte, certURL string, err error) {
	...
	res, err := c.post(ctx, nil /* c.Key */, c.dir.CertURL, req, wantStatus(http.StatusCreated))
	if err != nil {
		return nil, "", err
	}
	defer res.Body.Close()
...
func (c *Client) Register(ctx context.Context, acct *Account, prompt func(tosURL string) bool) (*Account, error) {
	...
	// RFC 8555-compliant account registration.
	if dir.OrderURL != "" {
...
func (c *Client) GetReg(ctx context.Context, url string) (*Account, error) {
	...
	// Assume the CA implements RFC 8555.
	if dir.OrderURL != "" {
...
func (c *Client) authorize(ctx context.Context, typ, val string) (*Authorization, error) {
	...
	res, err := c.post(ctx, nil /* c.Key */, c.dir.AuthzURL, req, wantStatus(http.StatusCreated))
	if err != nil {
		return nil, err
	}
	defer res.Body.Close()
...
func (c *Client) doReg(ctx context.Context, url string, typ string, acct *Account) (*Account, error) {
	...
	res, err := c.post(ctx, nil /* c.Key */, url, req, wantStatus(
