...
// LetsEncryptURL is the default ACME Directory URL used when the Manager's Client is nil.
...
type Manager struct {
	...
	//
	// If Client is nil, a zero-value acme.Client is used with LetsEncryptURL
