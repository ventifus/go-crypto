...
func TestHTTPHandlerDefaultFallback(t *testing.T) {
	tt := []struct {
		...
		{"GET", "http://example.org", 301, "https://example.org"},
		{"GET", "http://example.org/foo", 301, "https://example.org/foo"},
		{"GET", "http://example.org/foo/bar/", 301, "https://example.org/foo/bar/"},
		{"GET", "http://example.org/?a=b", 301, "https://example.org/?a=b"},
		{"GET", "http://example.org/foo?a=b", 301, "https://example.org/foo?a=b"},
		{"GET", "http://example.org:80/foo?a=b", 301, "https://example.org/foo?a=b"},
		{"HEAD", "http://example.org", 301, "https://example.org"},
		{"HEAD", "http://example.org/foo", 301, "https://example.org/foo"},
		{"HEAD", "http://example.org/foo/bar/", 301, "https://example.org/foo/bar/"},
		{"HEAD", "http://example.org/?a=b", 301, "https://example.org/?a=b"},
		{"HEAD", "http://example.org/foo?a=b", 301, "https://example.org/foo?a=b"},
